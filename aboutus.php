...
<body>
  ...
  <div class="content">
    ...
    <div class="left-01-all">
      <div class="box-main">
        <div class="title-all">เกี่ยวกับเรา</div>
        <div class="picture-about">
          <?php
          try {
            $stmt = $db->conn->prepare("SELECT img FROM `aboutus_image`");
            $stmt->execute();

            foreach ($stmt->fetchAll() as $row) {
          ?>
              <img src="back-office/images/aboutus/<?= $row["img"] ?>" width="1400" height="800" />
          <?php
            }
          } catch (Exception $e) {
            echo $e->getMessage();
        ...
        <div class="title-about">P.S CHILLER SERVICE</div>
        <div class="sub-about">
          <?php
          try {
