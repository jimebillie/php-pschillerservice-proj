...
--
-- Table structure for table `aboutus_image_home`
--

CREATE TABLE `aboutus_image_home` (
  `id` int(11) NOT NULL,
  `img` varchar(252) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `aboutus_image_home`
--

INSERT INTO `aboutus_image_home` (`id`, `img`) VALUES
(1, '20240605152622-aboutus-home.jpg');
...
--
-- Indexes for table `aboutus_image_home`
--
ALTER TABLE `aboutus_image_home`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `aboutus_image_home`
--
ALTER TABLE `aboutus_image_home`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
