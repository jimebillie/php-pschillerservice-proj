  ...
  <div class="content">
    ...
    <div class="left-01-all">
      <div class="box-main">
        ...
        ?>
            <div class="box-port-sub-list">
              <div class="picture-port-sub-list">
                <a href="portfolio-list-detail.php?id_main=<?=$_GET["id"]?>&id=<?= $row["id"] ?>">
                  <img src="back-office/images/portfolio/<?= $row["image"] ?>" width="400" height="267" /></a>
              </div>
              <div class="title-port-sub-list">
                <a href="portfolio-list-detail.php?id_main=<?=$_GET["id"]?>&id=<?= $row["id"] ?>">
                  <?= $row["name"] ?>
                </a>
              </div>
              ...
              <div class="more-04">
                <a href="portfolio-list-detail.php?id_main=<?=$_GET["id"]?>&id=<?= $row["id"] ?>">ดูเพิ่มเติม > </a>
              </div>
            </div>
        <?php
          }
        ...
        <div class="more-03"><a href="portfolio.php">
            < ย้อนกลับ</a>
        </div>
      </div>
